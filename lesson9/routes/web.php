...
Route::name('admin.')
    ...
    ->group(function () {
        ...
        Route::get('/parser', [ParserController::class, 'index'])->name('newsParser');

    });


Route::get('/auth/redirect/github', [LoginController::class, 'loginGitHub'])->name('githubLogin');
Route::get('/callback/{provider}', [LoginController::class, 'callbackGitHub'])->name('githubCallback');
