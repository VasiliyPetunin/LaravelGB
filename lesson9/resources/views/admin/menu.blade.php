...
<li class="nav-item">
    <a class="nav-link" href="{{ route('admin.crudNews') }}">Править новости</a>
</li>
...
<li class="nav-item">
    <a class="nav-link" href="{{ route('admin.crudUsers') }}">Править пользователей</a>
</li>

<li class="nav-item">
    <a class="nav-link" href="{{ route('admin.newsParser') }}">Парсинг новостей</a>
</li>
